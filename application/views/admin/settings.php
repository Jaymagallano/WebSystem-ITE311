            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="timezone" name="timezone">
                        ...
                        <option value="UTC" <?= ($settings['timezone'] ?? '') == 'UTC' ? 'selected' : '' ?>>UTC (GMT+0)
                        </option>
                ...
                <div class="form-check form-switch mb-3">
                    <input class="form-check-input" type="checkbox" id="notify_registration" name="notify_registration"
                        <?= ($settings['notify_registration'] ?? 0) ? 'checked' : '' ?>>
                ...
                <div class="form-check form-switch mb-3">
                    <input class="form-check-input" type="checkbox" id="notify_enrollment" name="notify_enrollment"
                        <?= ($settings['notify_enrollment'] ?? 0) ? 'checked' : '' ?>>
                ...
                <div class="form-check form-switch mb-3">
                    <input class="form-check-input" type="checkbox" id="notify_assignment" name="notify_assignment"
                        <?= ($settings['notify_assignment'] ?? 0) ? 'checked' : '' ?>>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="max_students_per_course"
                        name="max_students_per_course" value="<?= $settings['max_students_per_course'] ?? '50' ?>"
                        min="1">
                </div>
        ...
        <div class="card mt-4">
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <a href="<?= base_url('admin/backup_database') ?>" class="btn btn-outline-primary">
                ...
                <div class="mb-3">
                    ...
                    <a href="<?= base_url('admin/clear_cache') ?>" class="btn btn-outline-secondary">
                ...
                <div>
                    ...
                    <?= form_open('admin/reset_system', ['onsubmit' => "return confirm('Are you sure? This will delete ALL users and data except your account!');"]) ?>
