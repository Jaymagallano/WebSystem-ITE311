                    ...
                    <div class="card-footer bg-transparent border-0 p-4 pt-0">
                        <div class="d-grid gap-2">
                            <div class="btn-group" role="group">
                                <a href="<?= base_url('teacher/edit_course/'.$course->id) ?>" class="btn btn-outline-primary" title="Edit Course">
                                    <i class="bi bi-pencil-square"></i>
                                </a>
                                <a href="<?= base_url('teacher/students/'.$course->id) ?>" class="btn btn-outline-info" title="View Students">
                                    <i class="bi bi-people-fill"></i>
                                </a>
                                <a href="<?= base_url('teacher/materials/'.$course->id) ?>" class="btn btn-outline-success" title="Course Materials">
            ...
            <div class="card border-0" style="background: linear-gradient(135deg, rgba(102, 126, 234, 0.1) 0%, rgba(118, 75, 162, 0.1) 100%);">
                <div class="card-body text-center py-5">
                    <div class="empty-state-icon mb-4">
                        <i class="bi bi-journal-plus pulse" style="font-size: 5rem; background: var(--success-gradient); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;"></i>
                    </div>
                    <h3 class="fw-bold mb-3">Ready to Create Your First Course? 🚀</h3>
                    <p class="text-muted mb-4 fs-5">Start your teaching journey by creating engaging courses for your students.</p>
                    <div class="d-flex justify-content-center gap-3">
                        ...
                        <button class="btn btn-outline-primary btn-lg px-4" data-bs-toggle="modal" data-bs-target="#courseGuideModal">
