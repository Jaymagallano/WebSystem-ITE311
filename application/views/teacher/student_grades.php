        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a
                        href="<?= base_url('teacher/grades/' . $course->id) ?>"><?= $course->code ?></a></li>
                        ...
                        <div class="text-center">
                            ...
                            <p class="h2">
                                <?php if ($average_grade > 0): ?>
                                    <span
                                        class="badge bg-<?= $average_grade >= 75 ? 'success' : ($average_grade >= 60 ? 'warning' : 'danger') ?>">
                                        ...
                                        <td>
                                            <?php if ($submission->submitted_at): ?>
                                                <button type="button" class="btn btn-sm btn-outline-primary grade-btn"
                                                    ...
                                                    data-course-id="<?= $course->id ?>" data-student-id="<?= $student->id ?>">
            ...
            <form id="gradeForm" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="scoreInput" name="score" min="0" step="0.01"
                            required>
