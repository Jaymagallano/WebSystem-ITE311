    ...
    <div class="col-md-8 mx-auto">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="post" action="<?= base_url('student/submit_assignment/'.$assignment->id) ?>" enctype="multipart/form-data">
                    <div class="mb-3">
                    ...
                    <div class="alert alert-warning">
                        <i class="bi bi-exclamation-triangle"></i> <strong>Important:</strong> Make sure your file is correct before submitting. You can resubmit if needed.
                    </div>
