                                ...
                                <?php foreach ($assignments as $assignment): ?>
                                    <tr class="assignment-row">
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="assignment-icon me-3"
                                                    style="width: 40px; height: 40px; background: var(--primary-gradient); border-radius: 0px; display: flex; align-items: center; justify-content: center; color: white;">
                                        ...
                                        <td>
                                            <div>
                                                <span class="badge"
                                                    style="background: var(--success-gradient); color: white;"><?= $assignment->course_code ?></span>
                                        ...
                                        <td>
                                            ...
                                            ?>
                                            <div
                                                class="<?= $is_overdue ? 'text-danger' : ($days_left <= 3 ? 'text-warning' : 'text-success') ?>">
                                        ...
                                        <td>
                                            <small
                                                class="text-muted"><?= date('M d, Y', strtotime($assignment->created_at)) ?></small>
                                        </td>
                                        <td>
                                            <div class="btn-group" role="group">
                                                <a href="<?= base_url('teacher/edit_assignment/' . $assignment->id) ?>"
                                                    class="btn btn-sm btn-outline-primary" title="Edit Assignment">
                                                    <i class="bi bi-pencil-square"></i>
                                                </a>
                                                <a href="<?= base_url('teacher/assignment_submissions/' . $assignment->id) ?>"
                                                    class="btn btn-sm btn-outline-success" title="View Submissions">
                                                    <i class="bi bi-eye-fill"></i>
                                                </a>
                                                <a href="<?= base_url('teacher/assignment_stats/' . $assignment->id) ?>"
                                                    class="btn btn-sm btn-outline-info" title="Assignment Stats">
                                ...
                                <tr>
                                    <td colspan="6" class="text-center py-5">
                                        <div class="empty-state">
                                            <i class="bi bi-clipboard-plus pulse"
                                                style="font-size: 4rem; background: var(--warning-gradient); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;"></i>
