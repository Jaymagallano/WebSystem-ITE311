    ...
    <div class="col-md-8 mx-auto">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="post" action="<?= base_url('teacher/create_assignment') ?>">
                    <div class="mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="datetime-local" class="form-control" id="due_date" name="due_date" value="<?= set_value('due_date') ?>" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="max_points" class="form-label">Max Points *</label>
                                <input type="number" class="form-control" id="max_points" name="max_points" value="<?= set_value('max_points', 100) ?>" min="1" required>
                            </div>
                        </div>
                    </div>
